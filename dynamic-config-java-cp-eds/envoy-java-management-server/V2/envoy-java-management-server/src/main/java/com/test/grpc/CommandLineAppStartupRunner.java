...
public class CommandLineAppStartupRunner implements CommandLineRunner {
	...
	private void startServer() throws IOException, InterruptedException {
		...
		cache.setSnapshot(GROUP,
				Snapshot.create(ImmutableList.of(), ImmutableList.of(createEndpoint("some_service", 8000)),
		...
		cache.setSnapshot(GROUP,
				Snapshot.create(ImmutableList.of(), ImmutableList.of(createEndpoint("some_service", 1234)),
						ImmutableList.of(), ImmutableList.of(), ImmutableList.of(), "1"));
