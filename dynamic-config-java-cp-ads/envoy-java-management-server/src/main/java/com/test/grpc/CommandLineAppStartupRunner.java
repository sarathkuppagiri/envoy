...
public class CommandLineAppStartupRunner implements CommandLineRunner {
	...
	private void startServer() throws IOException, InterruptedException {
		...
		cache.setSnapshot(GROUP,
				createSnapshot(true, "some_service", "127.0.0.1", 8000, "sample-listener", 10000, "local_route", "1"));
	...
	static Snapshot createSnapshot(boolean ads, String clusterName, String endpointAddress, int endpointPort,
			String listenerName, int listenerPort, String routeName, String version) {
		...
		return Snapshot.create(ImmutableList.of(cluster), ImmutableList.of(endpoint), ImmutableList.of(listener),
